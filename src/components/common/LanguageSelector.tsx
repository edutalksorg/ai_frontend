    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <button
                ...
                className="flex items-center gap-1 sm:gap-2 px-1.5 py-1.5 sm:px-3 sm:py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors border border-transparent focus:outline-none focus:ring-2 focus:ring-red-500/50"
                    ...
                    <div className="max-h-80 overflow-y-auto custom-scrollbar">
                        ...
                        {hasMoreLanguages && (
                            <button
                                ...
                                className="w-full text-left px-4 py-3 text-sm text-red-600 dark:text-red-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors font-medium border-t border-slate-100 dark:border-slate-800 flex items-center gap-2"
                            >
                                <Globe size={16} />
                                View All Languages...
                            </button>
