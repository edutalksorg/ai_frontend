                                                ...
                                                {isLocked ? (
                                                    ...
                                                    <>
                                                        <div className="w-full sm:w-auto">
                                                            {bestScore !== null && (
                                                                <div className="flex items-center gap-3">
                                                                    <div className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-sm border-4 ${(bestScore ?? 0) >= 80 ? 'border-green-500 text-green-600' : 'border-orange-500 text-orange-600'
                                                                        }`}>
                                                                        {bestScore}%
                                                                    </div>
                    ...
                    <div className="flex items-center justify-between gap-4 mt-8">
                        ...
                        <button
                            ...
                            className={`px-8 py-3 rounded-xl text-sm font-bold transition-all flex items-center justify-center gap-2 border bg-white dark:bg-white/5 border-slate-200 dark:border-white/10 ${currentQuizIndex >= unlockedIndex || currentQuizIndex === quizzes.length - 1
                                ? 'opacity-50 cursor-not-allowed'
                                : 'hover:bg-slate-50 dark:hover:bg-white/10 text-pink-500 border-pink-500/30'
                                }`}
                        >
