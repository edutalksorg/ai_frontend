        ...
        return (
            <div className="max-w-5xl mx-auto space-y-8 animate-fadeIn">
                ...
                <div className="glass-panel p-8 rounded-3xl relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-12">
                        <div className="relative group">
                            <div className="w-40 h-40 rounded-full p-1 bg-gradient-to-br from-[#E10600] to-[#0E1A2B] shadow-xl">
                                <div className="w-full h-full rounded-full bg-white border-4 border-white overflow-hidden relative">
                                    {profile.avatarUrl ? (
                                        <img src={profile.avatarUrl} alt="Profile" className="w-full h-full object-cover" />
                                    ) : (
                                        <div className="w-full h-full flex items-center justify-center text-5xl font-bold text-white bg-red-600">
                ...
                <div className={`glass-card relative overflow-hidden rounded-3xl p-8 text-white shadow-2xl transition-transform hover:-translate-y-1 duration-300 ${currentSubscription
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-white/5 rounded-full blur-[120px] pointer-events-none" />

                    <div className="relative z-10 flex flex-col items-start sm:flex-row sm:items-center justify-between gap-6">
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                <div className={`p-2 rounded-xl ${currentSubscription ? 'bg-white/20' : 'bg-gray-700'}`}>
                            ...
                            <div>
                                <p className={`${currentSubscription ? 'text-indigo-100/80' : 'text-white/80'} text-sm font-bold uppercase tracking-wider mb-1`}>{t('profilePage.currentPlanLabel')}</p>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                {currentSubscription && (
                                    <span className={`${currentSubscription ? 'text-indigo-100/70' : 'text-white/70'} text-sm font-medium`}>
                        ...
                        <Button
                            className={`${currentSubscription ? '!bg-white !text-red-600' : '!bg-white !text-[#E10600]'} hover:bg-white/90 font-bold px-8 py-4 rounded-xl shadow-xl shadow-black/20`}
                ...
                <div className="glass-panel p-8 rounded-3xl">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                        <div>
                            <h3 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2 mb-1">
                                <User className="text-[#E10600]" size={24} />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#E10600] transition-colors" size={20} />
                                <input
                                    type="text"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <Phone className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#E10600] transition-colors" size={20} />
                                <input
                                    type="tel"
                    ...
                    {isEditing && (
                        <div className="flex items-center justify-center sm:justify-start gap-4 mt-8 pt-6 border-t border-slate-200/50 dark:border-white/5 animate-in fade-in slide-in-from-top-2">
                            <Button onClick={handleUpdateProfile} className="bg-[#E10600] hover:bg-[#b80000] text-white shadow-lg shadow-red-500/30">
                    ...
                    return (
                        <button
                            ...
                            className={`flex-1 min-w-fit md:min-w-[120px] flex items-center justify-center gap-2 px-3 md:px-4 py-3 rounded-xl font-bold transition-all duration-300 ${isActive
                                ? 'bg-white text-[#E10600] shadow-md border border-gray-100'
