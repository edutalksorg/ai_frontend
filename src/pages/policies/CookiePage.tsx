                                ...
                                const renderWithLinks = (text: string) => {
                                    ...
                                    return parts.map((part, i) => {
                                        if (emailRegex.test(part)) {
                                            return (
                                                <a key={i} href={`mailto:${part}`} className="text-amber-400 hover:text-amber-300 underline underline-offset-4 decoration-amber-500/30 transition-colors">
                                                    {part}
                                                </a>
                                            );
                                        }
                ...
                <div className="mt-20">
                    <div className="flex flex-col md:flex-row justify-between items-center bg-white/5 border border-white/5 backdrop-blur-md px-8 py-6 rounded-3xl gap-6">
                        ...
                        <div className="flex flex-wrap justify-center gap-6 text-sm font-semibold">
                            ...
                            <span className="text-slate-700 mx-2">|</span>
                            <Link to="/cookie-policy" className="text-amber-400">
                                Cookie Policy
                            </Link>
                        </div>
                    </div>
